...
export default function VotePage() {
  ...
  return (
    <PageContainer>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-zinc-100">Vote</h1>
      ...
      <Card className="mb-6">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <p className="text-2xl font-bold text-zinc-100">6d 23h 45m</p>
          </div>
          <div className="text-right">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="h-2 w-24 cursor-pointer appearance-none rounded-full bg-zinc-700 accent-indigo-600"
          />
